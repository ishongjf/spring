 ...
 * interface.
 *
 * 实现了BeanDefinition接口中定义的方法，并且提供了一些属性常量
 *
 * @author Rod Johnson
...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	////////////////////////////////依赖项检查，检查属性是否注入，需要将@Autowired放在对应属性的set方法上，而不是属性上/////////////////////////////////
	/**
	 * 不检查--默认
	...
	/**
	 * 是否在根据ByType和constructor自动注入的时候排除候选，true：候选人；false：非候选人
	 * ByName自动装配的时候还是会解析
	 */
